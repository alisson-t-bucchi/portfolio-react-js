            ...
            <nav className="fixed top-0 left-0 w-full z-50 bg-slate-900/70 backdrop-blur-md border-b border-white/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-4 flex justify-between items-center">
                    <div className="flex items-baseline gap-3">
                        ...
                        <span className="hidden sm:block text-sm text-blue-400 font-medium">
                            QA & Data Smart Solutions
                        </span>
                    </div>
                    ...
                    <div className={`${menuVisible ? "flex" : "hidden"} lg:flex flex-row items-center justify-center gap-4 sm:gap-6 lg:gap-8 font-bold text-lg sm:text-xl lg:text-2xl absolute lg:static top-16 left-1/2 -translate-x-1/2 lg:translate-x-0 w-auto lg:w-auto lg:bg-transparent shadow-lg lg:shadow-none p-3 lg:p-0 whitespace-nowrap`}>
